...
async def encode_mp3(
    ...
    *,
    ...
    try:
        ...
        raise AppError(504, "PROCESS_TIMEOUT", "MP3 轉換超過時間限制。", True) from exc
    except ProcessFailed as exc:
        raise AppError(500, "MP3_ENCODE_FAILED", "無法產生 MP3 下載檔。", True) from exc
    return output
